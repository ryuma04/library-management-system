...
Partial Public Class Database2DataSet
    ...
    Partial Public Class AdminDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddAdminRow(ByVal Name As String, ByVal Email As String, ByVal Password As String, ByVal Age As Integer) As AdminRow
            Dim rowAdminRow As AdminRow = CType(Me.NewRow,AdminRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Email, Password, Age}
    ...
    Partial Public Class AdminRow
        ...
        Public Function IsAgeNull() As Boolean
            Return Me.IsNull(Me.tableAdmin.AgeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetAgeNull()
            Me(Me.tableAdmin.AgeColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace Database2DataSetTableAdapters
    ...
    Partial Public Class AdminTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Admin` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` "& _ 
                "= ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Passwo"& _ 
                "rd` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?))"& _ 
                ")"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Admin` (`Name`, `Email`, `Password`, `Age`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Admin` SET `Name` = ?, `Email` = ?, `Password` = ?, `Age` = ? WHERE ((`ID"& _ 
                "` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Email` "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.LMS.My.MySettings.Default.Database2ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Name, Email, [Password], Age FROM Admin"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Email As String, ByVal Original_Password As String, ByVal Original_Age As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Email As String, ByVal Password As String, ByVal Age As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Email As String, ByVal Password As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Email As String, ByVal Original_Password As String, ByVal Original_Age As Global.System.Nullable(Of Integer)) As Integer
            If (Name Is Nothing) Then
